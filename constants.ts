...
Ровно два варианта разваития событий:
1. Если еще не прошло время выполнения задачи (dueAt) или если dueAt вообще нету, просто запланируй следующее напоминание через task-update комманду в зависимости от срочности.
2. Если время выполнения задачи уже прошло или наступило время следующей из той же рутины то проваливай задачу с помощью task-fail
...
Никаких других действий сейчас делать нельзя
