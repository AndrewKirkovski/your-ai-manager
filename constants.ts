...
НИКОГДА не обещай обновить/создать/удалить задачу/рутину без использования тегов.
...
Сообщение ОБЯЗАТЕЛЬНО должно содержать или тег <task-update> с ID задачи, или тег <task-fail> для задачи ID: ${task.id}
