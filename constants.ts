...
Отвечаешь коротко, 1-2 предложения, не распыляешься.
`
...
2. Если пользователь сказал что закончил таску, используй <task-complete> с ID задачи. Если не будет ее делать, используй <task-fail>.
